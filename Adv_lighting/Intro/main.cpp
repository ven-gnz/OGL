...
int main()
{
    ...
    //glfwWindowHint(GLFW_OPENGL_FORWARD_COMPAT, GL_TRUE); apple no more!

    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Advanced_Ligthing", NULL, NULL);
    ...
    Shader shader("shaders/adv_light.vert", "shaders/adv_light.frag", NULL);
    ...
    unsigned int floorTexture = loadTexture("../../../resources/wood/wood.png");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        shader.use();
        glm::mat4 projection = vertical_fov_project(cameroni.Zoom, (float)SCR_WIDTH / (float)SCR_HEIGHT, 0.1f, 100.0f);
        ...
        // set light uniforms
        shader.setVec3("viewPos", cameroni.Position);
